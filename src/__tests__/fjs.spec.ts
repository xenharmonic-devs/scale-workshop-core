...
describe('FJS interval constructor', () => {
  it.each([
    ['P', 8, [], [], '2/1'],
    ['P', 5, [], [], '3/2'],
    ['M', 3, [5], [], '5/4'],
    ...
    (quality, degree, superscripts, subscripts, fraction) => {
      const interval = toJustIntonation(
        quality,
        degree,
        superscripts,
        subscripts
...
describe('Absolute FJS pitch constructor', () => {
  it.each([
    ['C', [], 4, [], [], '1/1'],
    ['C', [], 5, [], [], '2/1'],
    ['F', [], 4, [], [], '4/3'],
    ...
    'Constructs %s%s%s%s%s',
    (nominal, accidentals, octave, superscripts, subscripts, fraction) => {
      const interval = absoluteToJustIntonation(
        nominal,
        accidentals,
        octave,
        superscripts,
