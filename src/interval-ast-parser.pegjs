{{
  function VariableDeclaration(id, value) {
    return {
...
VariableDeclaration
  = _ '$' id: VariableID _ '=' value: Expression { return VariableDeclaration(id, value) }
...
VariableAccess
  = '$' id:(@VariableID / $('-'? [0-9]+) / $'#'+ / '') { return VariableAccess(id) }
